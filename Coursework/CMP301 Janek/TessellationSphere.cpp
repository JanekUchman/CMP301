...
TessellationSphere::TessellationSphere(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int resolution)
{
...
TessellationSphere::~TessellationSphere()
{
...
void TessellationSphere::initBuffers(ID3D11Device* device)
{
	VertexType* vertices;
	...
	vertexCount = ((6 * m_resolution)*m_resolution) * 6;
...
void TessellationSphere::sendData(ID3D11DeviceContext* deviceContext, D3D_PRIMITIVE_TOPOLOGY top)
{
	unsigned int stride;
	unsigned int offset;
