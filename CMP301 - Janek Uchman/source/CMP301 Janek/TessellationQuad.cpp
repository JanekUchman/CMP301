...
TessellationQuad::TessellationQuad(ID3D11Device* device, ID3D11DeviceContext* deviceContext, XMFLOAT2 positionModifier) 
{

	XMFLOAT3 _vertices[4] =
	{
		XMFLOAT3(0.5 +positionModifier.x, -0.5, -0.5 + positionModifier.y),// top left
		XMFLOAT3(0.5 + positionModifier.x, -0.5, 0.5 + positionModifier.y), //bottom left
		XMFLOAT3(-0.5 + positionModifier.x, -0.5, 0.5 + positionModifier.y), //bottom right
		XMFLOAT3(-0.5 + positionModifier.x, -0.5, -0.5 + positionModifier.y) //top right
