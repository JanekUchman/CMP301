...
void App1::init(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight, Input *in, bool VSYNC, bool FULL_SCREEN)
{
	...
	orthoMesh = new OrthoMesh(renderer->getDevice(), renderer->getDeviceContext(), screenWidth / 10, screenHeight / 10, 20, 20);
...
void App1::depthPass()
{
	...
	worldMatrix = XMMatrixTranslation(5.f + animationChange, 7.f, 5.f);
	...
	worldMatrix = renderer->getWorldMatrix();
	worldMatrix = XMMatrixTranslation(0.f, 7.f, -5.f + animationChange);
...
void App1::finalPass()
{
	...
	textureShader->setShaderParameters(renderer->getDeviceContext(), worldMatrix, viewMatrix, projectionMatrix, shadowMap->getShaderResourceView());
...
void App1::gui()
{
	...
	ImGui::SliderFloat("Animation factor", &animationChange, -10, 10);
